...
public class GossipService {
    ...
    private CommunicationService socketService;
    private Node self = null;
    private ConcurrentHashMap<String, Node> nodes =
            new ConcurrentHashMap<>();
    private boolean stopped = false;
    private GossipConfiguration gossipConfig = null;
    ...
    public GossipService(InetSocketAddress inetSocketAddress,
        ...
        this.socketService = new CommunicationService(inetSocketAddress.getPort());
